    ...
    <main>
      <section className="bg-ink py-20 text-white">
        <div className="mx-auto max-w-6xl px-5">
          ...
          <p className="mt-4 max-w-[52ch] text-[15px] text-sky/45">
        ...
        <div className="mx-auto grid max-w-6xl divide-x divide-line sm:grid-cols-2 lg:grid-cols-5">
          {[
            ...
            <div key={b.title} className="px-5 py-7">
              ...
              <p className="mt-1 text-xs text-ink/75">{b.sub}</p>
            </div>
          ))}
        </div>
      </section>
          ...
          <div className="mx-auto max-w-2xl divide-y divide-line">
            {[
              ...
              <details key={faq.q} className="group">
                ...
                <p className="pb-5 text-[14px] leading-relaxed text-ink/75">{faq.a}</p>
              </details>
            ))}
          </div>
        </div>
      ...
      <section className="border-t border-line">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-6 px-5 py-12">
          <div>
            ...
            <p className="mt-1 text-[14px] text-ink/75">Pode existir apoio financeiro. Fala connosco.</p>
          </div>
          <Link
            href="/sobre"
